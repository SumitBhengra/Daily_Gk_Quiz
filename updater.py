...
# Supabase configuration with the full, valid service_role key fallback
SUPABASE_URL = os.environ.get("SUPABASE_URL", "https://gprgdzahgyebsghbgoav.supabase.co")
SUPABASE_KEY = os.environ.get("SUPABASE_KEY", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImdwcmdkemFoZ3llYnNnaGJnb2F2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4NTIzNDgzMywiZXhwIjoyMTAwODEwODMzfQ.2jziL8RHMIOtLMTfRUObb__ZkssawAzDWKhq5n7du4k")
supabase = create_client(SUPABASE_URL, SUPABASE_KEY)

# Gemini API configuration
GEMINI_API_KEY = os.environ.get("GEMINI_API_KEY", "AQ.Ab8RN6JaYYwDs24nR0MJERBCSJJyOK6gCDerZzTGOrj5q3dRIw")
